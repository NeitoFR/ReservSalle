			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">Planifier une formation</h1>
					</div>
				</div>
				<!-- /.container-fluid -->
								...
								<form class="form-horizontal" method="post" action="formations">
									<fieldset>
										<div class="form-group">
											<div class="col-md-8">
												<input id="nom_Formation" name="nom_Formation" type="text"
													placeholder="Nom de la formation" class="form-control">
											</div>
										</div>
										<div class="form-group">
											<div class="col-md-8">
										...
										<div class="form-group">
											<div class="col-md-8">
												<input id="nb_Demi_Journee" name="nb_Demi_Journee"
													type="number"
													placeholder="Nombre de demie journée" class="form-control">
											</div>
										</div>
										...
										<div class="form-group">
											<div class="custom-control custom-checkbox small col-md-8">
												<input type="checkbox" class="custom-control-input"
													id="apresMidiCheck" name="apresMidiCheck" value="1"> <label
													class="custom-control-label" for="apresMidiCheck">Commence
													l'après midi ?</label>
												<input id='apresMidiCheckHidden' type='hidden' value='0' name='apresMidiCheck'>
											</div>
										</div>
